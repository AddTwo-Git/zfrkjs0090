		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData v4 Trip People Test",
									"targetURL": "#readianzrdstemp01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"readianzrdstemp01-display": {
								"semanticObject": "readianzrdstemp01",
								"action": "display",
								"description": "OData v4 Trip People Test",
								"title": "OData v4 Trip People Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=readians.zfrkjs0090",
									"url": sap.ui.require.toUrl("readian/zrdstemp01")
								}
							}
						}
					}
